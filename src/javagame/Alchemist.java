...
public class Alchemist extends BasicGameState{
	...
	int[] stand = {200,200};
	float buckyPositionX = javagame.Player.Alchemist[0];
	float buckyPositionY = javagame.Player.Alchemist[1];
	float shiftX = buckyPositionX + javagame.Player.Alchemist[2];
	float shiftY = buckyPositionY + javagame.Player.Alchemist[3];
	Image mask;
	String looking = "front";

	public Alchemist(int state){
		
	}
	
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException{
		door = new Music("son/Door.ogg");
		worldMap = new Image("res/Map/Alchemist (Black) (bird).png");
	...
	public void render(GameContainer gc, StateBasedGame sbg, Graphics g)throws SlickException{
		worldMap.draw(javagame.Player.Alchemist[0], javagame.Player.Alchemist[1]);
		bucky.draw(shiftX, shiftY);
		
		g.drawString("Buckys X: " + javagame.Player.Alchemist[0] + "\nBuckys Y: " + javagame.Player.Alchemist[1] + " ID: " + sbg.getCurrentStateID(), 400, 20);
		...
		g.drawString("Buckys X: " + javagame.Player.Alchemist[0] + "\nBuckys Y: " + javagame.Player.Alchemist[1], 400, 20);
	...
	public void update(GameContainer gc, StateBasedGame sbg, int delta) throws SlickException{
		...
		if(input.isKeyDown(Input.KEY_UP) || input.isKeyDown(Input.KEY_W)){
			bucky = movingUp1;
			javagame.Player.Alchemist[1] += delta * .1f;
			looking = "back";
			//Wall
			if(javagame.Player.Alchemist[1]>130){
				javagame.Player.Alchemist[1] -= delta * .1f;
			}
			//Pillars
			if((javagame.Player.Alchemist[0]>200 && javagame.Player.Alchemist[0]<270 && javagame.Player.Alchemist[1]>50 && javagame.Player.Alchemist[1]<110) || 
			   (javagame.Player.Alchemist[0]>120 && javagame.Player.Alchemist[0]<190 && javagame.Player.Alchemist[1]>50 && javagame.Player.Alchemist[1]<110) || 
			   (javagame.Player.Alchemist[0]>200 && javagame.Player.Alchemist[0]<270 && javagame.Player.Alchemist[1]>-30 && javagame.Player.Alchemist[1]<30) || 
			   (javagame.Player.Alchemist[0]>120 && javagame.Player.Alchemist[0]<190 && javagame.Player.Alchemist[1]>-30 && javagame.Player.Alchemist[1]<30)){
				javagame.Player.Alchemist[1] -= delta * .1f;
			}
		}
		...
		if(input.isKeyDown(Input.KEY_DOWN) || input.isKeyDown(Input.KEY_S)){
			...
			looking = "front";
			//Wall
			if(javagame.Player.Alchemist[1]<-48){
				javagame.Player.Alchemist[1] += delta * .1f;
				//Door - Rift
				if(javagame.Player.Alchemist[0]>190 && javagame.Player.Alchemist[0]<200 ){
		...
		if(input.isKeyDown(Input.KEY_LEFT) || input.isKeyDown(Input.KEY_A)){
			bucky = movingLeft1;
			javagame.Player.Alchemist[0] += delta * .1f;
			looking = "left";
			//Wall
			if(javagame.Player.Alchemist[0]>280){
				javagame.Player.Alchemist[0] -= delta * .1f;
			}
			//Pillars
			if((javagame.Player.Alchemist[0]>200 && javagame.Player.Alchemist[0]<270 && javagame.Player.Alchemist[1]>50 && javagame.Player.Alchemist[1]<110) || 
		...
		if(input.isKeyDown(Input.KEY_RIGHT) || input.isKeyDown(Input.KEY_D)){
			...
			looking = "right";
			//Wall
			if(javagame.Player.Alchemist[0]<110){
				javagame.Player.Alchemist[0] += delta * .1f;
			}
			//Pillars
			if((javagame.Player.Alchemist[0]>200 && javagame.Player.Alchemist[0]<270 && javagame.Player.Alchemist[1]>50 && javagame.Player.Alchemist[1]<110) || 

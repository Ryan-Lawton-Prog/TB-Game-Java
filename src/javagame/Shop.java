...
public class Shop extends BasicGameState{
	...
	public void render(GameContainer gc, StateBasedGame sbg, Graphics g)throws SlickException{
		...
		//Equipment
		if(equipment){
			g.drawString("$"+javagame.Player.money, 50, 310);
			Button.draw(200,280);
			g.drawString("Back", 280, 310);
			if(back){
		        Button_Pressed.draw(200,280);
    		    if(back == false){
	    	    	g.clear();
		        }
		    }
	    	...
	    	if(equipped){
	    		if((javagame.Player.equipped_weapon[2].equals(-1)) == false){
                	...
                	g.drawString("Damage: " + (Integer)(javagame.Player.equipped_weapon[1]), 310, 60);
            	    g.drawString("Str: " + (Integer)(javagame.Player.equipped_weapon[4]), 310, 90);
                	g.drawString("Dex: " + (Integer)(javagame.Player.equipped_weapon[5]), 310, 120);
            	    g.drawString("Int: " + (Integer)(javagame.Player.equipped_weapon[6]), 310, 150);
                	g.drawString("Vit: " + (Integer)(javagame.Player.equipped_weapon[7]), 310, 180);
            	    g.drawString("Drop Rate: " + (Integer)(javagame.Player.equipped_weapon[8]), 310, 210);
            	    g.drawString("Class: " + (String)(javagame.Player.equipped_weapon[3]), 310, 240);
	    		}else{
	    			Item_Select.draw(230,110);
	    ...
	    if(pots){
	    	//Symbols
	    	g.drawString("$"+javagame.Player.money, 440, 5);
	        ...
	        g.drawString("$75", 15, 146);
	        g.drawString("$200", 15, 236);
	        g.drawString("$400", 15, 326);
	        g.drawString("$75", 230, 146);
	        g.drawString("$200", 230, 236);
	        g.drawString("$400", 230, 326);
	        g.drawString("$75", 445, 146);
	        g.drawString("$200", 445, 236);
	        g.drawString("$400", 445, 326);
	        g.drawString("Heals: 100hp", 65, 146);
	        g.drawString("Heals: 200hp", 65, 236);
	        g.drawString("Heals: 300hp", 65, 326);
	        g.drawString("Heals: 100mp", 280, 146);
	        g.drawString("Heals: 200mp", 280, 236);
	        g.drawString("Heals: 300mp", 280, 326);
	        g.drawString("Gives: 2rp", 495, 146);
	        g.drawString("Gives: 4rp", 495, 236);
	        g.drawString("Gives: 6rp", 495, 326);
	    	//Back
	...
	public void update(GameContainer gc, StateBasedGame sbg, int delta) throws SlickException{
		...
		if(equipment){
			//Back Button
	    	if((posX>200 && posX<400) && (posY>0 && posY<80)){
		    	back = true;
			    if(Mouse.isButtonDown(0) && tic <= 0){
					tic = 50;
					equipment = false;
		...
		if(pots){
			...
			if((posX>5 && posX<205) && (posY>190 && posY<270)){
				...
				if(Mouse.isButtonDown(0) && tic <= 0){
					tic = 20;
					if(javagame.Player.lesser_potions < 20 && javagame.Player.money >= 75){
					    javagame.Player.lesser_potions += 1;
						javagame.Player.money -= 75;
					}
    			}
			}else{
				BL_Potion = false;
			...
			if((posX>5 && posX<205) && (posY>100 && posY<180)){
				...
				if(Mouse.isButtonDown(0) && tic <= 0){
					tic = 20;
					if(javagame.Player.potions < 20 && javagame.Player.money >= 200){
					    javagame.Player.potions += 1;
						javagame.Player.money -= 200;
					}
    			}
			}else{
				BPotion = false;
			...
			if((posX>5 && posX<205) && (posY>10 && posY<90)){
				...
				if(Mouse.isButtonDown(0) && tic <= 0){
					tic = 20;
					if(javagame.Player.greater_potions < 20 && javagame.Player.money >= 400){
					    javagame.Player.greater_potions += 1;
						javagame.Player.money -= 400;
					}
    			}
			}else{
				BG_Potion = false;
			...
			if((posX>220 && posX<420) && (posY>190 && posY<270)){
				...
				if(Mouse.isButtonDown(0) && tic <= 0){
					tic = 20;
					if(javagame.Player.lesser_mana < 20 && javagame.Player.money >= 75){
			...
			if((posX>220 && posX<420) && (posY>100 && posY<180)){
				...
				if(Mouse.isButtonDown(0) && tic <= 0){
					tic = 20;
					if(javagame.Player.mana < 20 && javagame.Player.money >= 200){
			...
			if((posX>220 && posX<420) && (posY>10 && posY<90)){
				...
				if(Mouse.isButtonDown(0) && tic <= 0){
					tic = 20;
					if(javagame.Player.greater_mana < 20 && javagame.Player.money >= 400){
			...
			if((posX>435 && posX<635) && (posY>190 && posY<270)){
				...
				if(Mouse.isButtonDown(0) && tic <= 0){
					tic = 20;
					if(javagame.Player.lesser_regen < 20 && javagame.Player.money >= 75){
			...
			if((posX>435 && posX<635) && (posY>100 && posY<180)){
				...
				if(Mouse.isButtonDown(0) && tic <= 0){
					tic = 20;
					if(javagame.Player.regen < 20 && javagame.Player.money >= 200){
			...
			if((posX>435 && posX<635) && (posY>10 && posY<90)){
				...
				if(Mouse.isButtonDown(0) && tic <= 0){
					tic = 20;
					if(javagame.Player.greater_regen < 20 && javagame.Player.money >= 400){
	...
	public void equipping(int number){
		if((javagame.Player.Weapons[number][3].equals("null")) == false){
			equipping_time = 40;
			javagame.Player.money += (Integer) javagame.Player.Weapons[number][2];
			javagame.Player.Weapons[number][0] = "";
			javagame.Player.Weapons[number][1] = -1;
			javagame.Player.Weapons[number][2] = -1;
			javagame.Player.Weapons[number][3] = "null";
			javagame.Player.Weapons[number][4] = -1;
			javagame.Player.Weapons[number][5] = -1;
			javagame.Player.Weapons[number][6] = -1;
			javagame.Player.Weapons[number][7] = -1;
			javagame.Player.Weapons[number][8] = -1;
			javagame.Player.Weapons[number][9] = -1;
			javagame.Player.Weapons[number][10] = "null";
			equipping = false;
		}
	}
